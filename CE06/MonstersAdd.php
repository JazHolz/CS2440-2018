...
//include 'dropSchemaLibrary.php';    /* commented out until you want to drop and recreate the schema/database (dropping schema/db will drop all tables in schema/db)*/
//include 'createSchemaLibrary.php';  /* comment out after schema/database is created or uncomment to recreate the schema/database */
...
//include 'dropTableMonsters.php';    /* commented out until you want to drop and recreate the table */
//include 'createTableMonsters.php';  /* comment out after table is created or uncomment to recreate the table */
